...
class Client{
    ...
    getPurcharses(){
        ...
        x.open('GET','http://192.168.100.195/Abarrotes/api/getSalesClient.php?client='+this.id)
        x.send()
...
function addClient(_client){
    ...
    btn_pay.addEventListener('click',()=>{client.pay();setTimeout(() => {window.location.reload()}, 1000);})
    //data
