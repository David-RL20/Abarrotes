const API_PRODUCTS = 'http://localhost/Abarrotes/api/AllProducts.php';
const API_DEPARTMENTS = 'http://localhost/Abarrotes/api/AllDepartments.php';
            ...
            editButton.onclick = function () {
                ...
                if (!editing) {
                    ...
                    if (editing) {
                        ...
                        x.open('POST', 'http://localhost/Abarrotes/api/AllProducts.php', true);
